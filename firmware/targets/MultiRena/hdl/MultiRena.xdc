...
set_property PACKAGE_PIN Y18 [get_ports clockHubOutP]
set_property PACKAGE_PIN Y19 [get_ports clockHubOutN]
...
create_generated_clock -name rena200 [get_pins {U_FanInBoard/U_MasterClockGen.U_RenaClkGen/MmcmGen.U_Mmcm/CLKOUT1}]
